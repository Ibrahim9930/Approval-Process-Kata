    ...
    public partial class new_logging_columns : Migration
    {
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 10, new DateTime(2021, 8, 5, 21, 44, 6, 681, DateTimeKind.Local).AddTicks(9525), "Elyse Cassin", 7, new DateTime(2021, 8, 6, 18, 20, 53, 146, DateTimeKind.Local).AddTicks(5166), new DateTime(2021, 8, 5, 23, 28, 15, 933, DateTimeKind.Local).AddTicks(1538) },
